...
$sql = "SELECT * FROM info ORDER BY pageID ASC";
			...
			<?php
					echo '<table border="1" cellpadding="5" cellspacing="0" width="50%">';
						while ($item = mysqli_fetch_assoc($items)){
							echo '<tr>';
								// echo '<td>' . $item['pageID'] . '</td>';
								echo '<td>' . $item['item'] . '</td>';
								echo '<td>' . $item['location'] . '</td>';
								// echo '<td>' . $user['firstname'] . '</td>';
								// echo '<td>' . $user['privs'] . '</td>';
								echo '<td><a href="update.php?pageID=' . $item['pageID'] . '">UPDATE</a></td>';
								echo '<td><a href="delete.php?pageID=' . $item['pageID'] . '">DELETE</a></td>';
							echo '</tr>';
						}
					echo '</table>';
				?>
